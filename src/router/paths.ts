...
export default {
  ...
  admin: {
    ...
    readingDetail: `${rootPaths.pageRoot}/admin/readings/:id`,
    invoices: `${rootPaths.pageRoot}/admin/invoices`,
    invoiceDetail: `${rootPaths.pageRoot}/admin/invoices/:id`,
    invoicesMorosos: `${rootPaths.pageRoot}/admin/invoices/morosos`,
